...
// // Loop through the cities array and create one marker for each city. This puts a circle based on teh size of the population on the map.  The population is based on the city data JSON object above.
